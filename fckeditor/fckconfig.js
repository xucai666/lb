...
FCKConfig.Plugins.Add( 'Media', 'zh,zh-cn' ) ;  //ÆôÓÃ²å¼þ
...
FCKConfig.ToolbarSets["Basic"] = [
	...
	['Undo','Redo','Rule'],
	['Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','-','Underline','PageBreak','Source'],
...
FCKConfig.MediaUploadAllowedExtensions	= ".(swf|flv|wmv|avi|rmvb)$" ;		// empty for all
