...
function get_real_path(){
	...
	$r = str_replace( $r,'',realpath(dirname(dirname(__file__)).'/../../../..'));
...
$Config['UserFilesPath'] = get_real_path().'swfupload/uploads/' ;
...
$Config['ConfigAllowedTypes'] = array('File', 'Image', 'Flash', 'Media','mp3') ;
