...
$.fn.pickColor=function(callback)   
 ...
 $.each(itemColors,function(n,v)   
  {   
  var $item=$('<a href="" title="'+v+'" style="float:left;"><img src="" width="10" height="10" border="0" style="background:'+v+';" /></a>').click(function(){callback(v);$colorBox.remove();return false;}).appendTo($colorBox);   
  })   
