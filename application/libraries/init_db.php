...
/**
 ...
 class Init_db {
 	...
 	public static function &get_init_db(){ 	
	...
	function get_page_link(){
 	...
 	function ms_fetch_all($page_size=null,$pri_key=null){
 		...
 		$link_str = $CI->init_page->array_to_url($_GET);		
 		$params = array( 		
 			'limit_to'=>$page_size,
	...
	function fetchAll($sql){
		return $this->getDs()->query($sql)->result_array();
	}
    ...
    function insert($table,$data){
 	...
 	function update($table,$data,$array_where){
 		...
 		$this->getDs()->update($table, $data,$where_str); 
 	}	
 
 } 
 
 function &get_init_db(){	
	return init_db::get_init_db();
}