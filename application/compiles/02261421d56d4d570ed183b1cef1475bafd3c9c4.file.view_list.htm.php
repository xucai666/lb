<?php /* Smarty version Smarty-3.1.14, created on 2013-08-17 16:43:37
         compiled from "application\templates\backend\blue\view_list.htm" */ ?>
<?php /*%%SmartyHeaderCode:25357520fa8391acc27-96642921%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '25357520fa8391acc27-96642921',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_520fa83936b898_49468933',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_520fa83936b898_49468933')) {function content_520fa83936b898_49468933($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'E:\\phpnow\\htdocs\\lb\\application\\libraries\\Smarty-3.1.14\\libs\\plugins\\modifier.date_format.php';
...
"/>
			...
			<input type="button" name="prev" value="上一级" onclick="location.href='<?php echo func_site_url(array('segments'=>"backend/templates/view_list/".((string)$_smarty_tpl->tpl_vars['root_path_parent']->value)),$_smarty_tpl);?>
'"/>

            <span id="spanButtonPlaceholder_view"></span>
            <input id="btnUpload" type="button" value="上传" style="width: 80px; height: 20px; " />
