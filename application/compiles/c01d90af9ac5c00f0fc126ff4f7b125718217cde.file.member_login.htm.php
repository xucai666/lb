<?php /* Smarty version Smarty-3.1.14, created on 2013-08-23 00:13:16
...
">
       <ul>
           <li>用户名：<input type="text" name="m_name" value="<?php echo $_smarty_tpl->tpl_vars['m_name']->value;?>
"/><?php echo form_error("m_name");?>
</li>
           <li> 密&nbsp;&nbsp;码：<input type="text" name="m_pass" /><?php echo form_error("m_pass");?>
</li>
