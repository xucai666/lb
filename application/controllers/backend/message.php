...
/**
 ...
 class Message extends CI_Controller{
	...
	function action_list(){	
		...
		//css	
		$this->cor_page->fetch_css(array('backend_message'));
	 ...
	 */
	 function action_save(){
	 	try{
	 		...
	 		$this->cor_page->pop_redirect('保存成功',"javascript:;");	 	
	 		
	 	}catch(Exception $e){
	 		$this->cor_page->pop_redirect($e->getMessage(),"javascript:;");	 
	 	}			
	 }
	...
	function action_del(){
		...
		try{
			...
			$this->db->delete($this->cor_db->table("message"));
	 		$this->cor_page->backend_redirect($this->act.'/action_list','删除成功');	 	
